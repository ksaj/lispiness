...
I actually got my "introduction" to Lisp through using Cakewalk to write/record music. Here's a manual describing [Cakewalk Application Language](http://members.ziggo.nl/t.valkenburgh/Cakewalk%20Application%20Language%20Programming%20Guide.pdf). If you're ondering what it looks like, here is a rousing rendition of [99 bottles](http://www.99-bottles-of-beer.net/language-cakewalk-cal-117.html). These days, I find CAL to be archaic, and am no fan of a lot of syntax choices - many of which strangely make their ugly appearance in the ARC Lisp dialect (which imo was written by a genius, but not written ingeniously... just sayin'.). 

Once I got into Artificial Life in the earliest part of the 90's, I instantly saw the Lisp connection and started doing all kinds of non-musical things in Cakewalk. The rest is history.
